...
import { CartItemOption } from "./components/CartItemOption";
...
export function CartItem({ item, index, onUpdate }) {
		...
		<div className="cart__item">
			<div className="cart__info">
				...
				{item.name.split(" ").length > 1 ? (
					<div className="cart__item_subtitle">
			...
			<CartItemCounter
				...
				index={index}
				onUpdate={onUpdate}
				setWindowOpen={setWcdIsShown}
			/>
			<div className="cart__item_image">
				<img
					src={require(`../../../../../../../../shared/images/products/${item.category}/${
						item.id
					}/${item.images[item.colors.indexOf(item.color)]}`)}
					alt="item_img"
				/>
				<div
			...
			<div
				className={`cart_window_confirm_deletion wcd ${
					wcdIsShown ? "show" : "hide"
				}`}
				ref={wcdRef}>
				<div className="wcd__content">
					...
					<div className="wcd__buttons">
						<div
							className="wcd__button"
							id="cancel"
							onClick={() => setWcdIsShown(false)}>
							No, cancel
						</div>
						<div
							className="wcd__button"
