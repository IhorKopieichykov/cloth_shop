...
export function Product({ product, isLoading }) {
	...
	const setColorImage = useCallback(
		(color) => {
			setColor(color);
			if (color) {
		...
		<div className="main__product product">
			<div className="product__preview">
					...
					<ul>
						{product?.images.map((img, index) => (
							<li
								...
								<img
									src={require(`../../../../../../shared/images/products/${product?.category}/${product?.id}/${img}`)}
									alt="prod_img"
									className="product__select_image"
				...
				<div className="product__preview_photo product__photo">
					<img
						src={require(`../../../../../../shared/images/products/${product?.category}/${product?.id}/${product?.images[imageIndex]}`)}
						alt="prod_img"
						className="product__photo_image"
					/>
				</div>
			</div>
			...
			<div className="product__description">
				...
				<div className="product__desc_text">
					Lorem ipsum dolor sit, amet consectetur adipisicing elit. Totam
					quaerat fuga eveniet nulla corrupti minus inventore. Vero fuga iure
					natus molestias ex, iste possimus illo obcaecati ad cumque earum
					maxime?
				</div>
			</div>
		</div>
