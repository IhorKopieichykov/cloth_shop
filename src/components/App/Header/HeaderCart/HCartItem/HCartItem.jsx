...
function HCartItem({currItem, index, onUpdate}){  
    ...
    const getItemPrice = useCallback((currItem) => {
    ...
    return (       
        <div className="hcart__item">
            ...
            <HItemCounter item={currItem} index={index} onUpdate={onUpdate} setWindowOpen={setHwcdIsShown}/>
            ...
            <div className={`hcart_window_confirm_deletion hwcd ${hwcdIsShown?"show":"hide"}`}
                ref={hwcdRef}>
