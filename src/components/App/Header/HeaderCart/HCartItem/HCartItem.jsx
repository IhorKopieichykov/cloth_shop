...
function HCartItem({currItem, index, onUpdate, updateCartItem}){    
    return (       
        <div className="hcart__item">
            <div className="hcart__item_info">
                ...
                <HItemOption item={currItem} index={index} onUpdate={onUpdate} type={"size"} updateCartItem={updateCartItem}/>
                <HItemOption item={currItem} index={index} onUpdate={onUpdate} type={"color"} updateCartItem={updateCartItem}/>                
            </div>
